...
import { registrarRecolector } from '../../services/recolector.js'
import { NavLink } from 'react-router-dom'

export default function NuevoRecolector () {
  ...
  const onFinish = async (values) => {
    ...
    try {
      const res = await registrarRecolector(values)
      console.log(res)
    } catch (error) {
      console.log(error)
    }
          ...
          <div className='grid grid-cols-2 gap-x-20'>
            <div>
              <div className='flex flex-row gap-x-6'>
                <Form.Item
                  name='claveTrabajador'
                  label='Clave de trabajador'
                >
